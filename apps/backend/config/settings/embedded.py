...
# Tzdata для embedded Postgres инжектится в CI (см.
# .github/workflows/build-windows-exe.yml шаг "Inject Postgres tzdata"),
# поэтому именованные TZ типа "Asia/Dushanbe" работают штатно.
USE_TZ = True
